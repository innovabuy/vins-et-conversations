...
export default function ProductModal({ product, onClose, onPrev, onNext, hasPrev, hasNext, onAddToCart, csePriceTtc, showFreeBottleBadge = true }) {
              ...
              <div className="flex-1 min-w-0 space-y-3">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {showFreeBottleBadge && (p.category_is_alcohol !== false && p.cat_is_alcohol !== false) && <span className="px-2 py-0.5 bg-amber-100 text-amber-800 rounded-full text-[10px] font-bold">12+1</span>}
